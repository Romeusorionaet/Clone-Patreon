...
export function InputHeader({ eventIndicatorVisible, scrolled }: Props) {
  ...
  return (
    <div
      ...
      className="input-header-container group focus-within:!mx-auto focus-within:!w-full data-[scroll=true]:border-c1 data-[value=true]:border-c1 max-md:mx-[5%] data-[scroll=true]:max-md:mx-4 data-[scroll=true]:max-md:w-9 data-[scroll=true]:max-md:justify-center"
    >
