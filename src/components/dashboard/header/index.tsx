...
const listNavigation = ['Criadores', 'Características', 'Preços', 'Recursos']
      ...
      <div className="relative flex w-full items-center justify-between gap-2 p-custom_container_header max-md:flex-wrap">
        <nav className="max-md:hidden">
          ...
          <ul ref={navRef} className="flex gap-1 xl:gap-10">
                ...
                >
                  <Link href="#">
                    <div className="overflow-hidden">
                      <span
                        data-content={item}
                        className={`bg-rise-fade-content before:content-[attr(data-content)] group-hover:animate-rise-from-bottom`}
                      >
                        {item}
                      </span>
                    </div>
            ...
            <li className="bg-rise-fade group cursor-pointer px-2 py-2 font-medium hover:border-transparent md:border md:py-custom_1">
              <Link href="#">
                <div className="overflow-hidden">
        ...
        <nav className="lg:flex lg:w-full lg:items-center lg:justify-center lg:pl-36">
        ...
        <div className="flex max-md:flex-col-reverse">
          ...
          <nav className="flex items-center gap-2">
            <Link
              href="#"
              className="bg-rise-fade group px-3 py-2 md:border md:p-custom_1 md:text-white"
            >
              <div className="overflow-hidden">
            ...
            <Link
              href="#"
              className="bg-rise-fade group rounded-full bg-white px-4 py-2 font-medium text-black md:px-6 md:py-custom_1"
            >
              <div className="overflow-hidden">
